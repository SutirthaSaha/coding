# Sliding Window
Problem:
Given an array and a number 'k', return the maximum sum of all possible subarrays of size 'k'.
...
### [Longest Substring Without any Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters)*
